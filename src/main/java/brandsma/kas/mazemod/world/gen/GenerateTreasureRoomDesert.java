...
public class GenerateTreasureRoomDesert extends GenerateTreasureRoom
{
    ...
    public GenerateTreasureRoomDesert(World world, Random random, int[] corner1, int mazesize, int cellsize, int foundationheight, int pathwidth, int baseheight)
    {
        ...
        world.setBlock(putX + 1, baseheight + 3, putZ + 1, Blocks.glowstone);
        world.setBlock(putX + 2, baseheight + 3, putZ + 1, Blocks.glowstone);
        world.setBlock(putX + 1, baseheight + 3, putZ + 2, Blocks.glowstone);
        world.setBlock(putX + 2, baseheight + 3, putZ + 2, Blocks.glowstone);
        world.setBlock(corner1[0] + Reference.TELEPORTER_LOCATION[this.metadata][0], corner1[1] + Reference.TELEPORTER_LOCATION[this.metadata][1], corner1[2] + Reference.TELEPORTER_LOCATION[this.metadata][2], ModBlocks.teleporter, 0, 2);
    }

    public void generateCorner1(int putX, int putY, int putZ)
    {
        this.world.setBlock(putX, putY, putZ + 1, Blocks.sandstone);
        this.world.setBlock(putX, putY, putZ + 2, Blocks.stone_slab, 1, 2);
        this.world.setBlock(putX + 1, putY, putZ, Blocks.sandstone);
        this.world.setBlock(putX + 1, putY, putZ + 1, Blocks.stone_slab, 1, 2);
        this.world.setBlock(putX + 2, putY, putZ, Blocks.stone_slab, 1, 2);
        this.world.setBlock(putX, putY + 3, putZ, Blocks.flowing_water);
    }
    ...
    public void generateCorner3(int putX, int putY, int putZ)
    {
        ...
        this.world.setBlock(putX, this.baseheight + 3, putZ, Blocks.glowstone);
