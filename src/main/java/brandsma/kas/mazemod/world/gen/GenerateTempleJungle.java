...
public class GenerateTempleJungle extends GenerateTemple
{
    ...
    public void callGeneration(int BlockX, int BlockZ, boolean forceGeneration)
    {
        if (forceGeneration)
        {
            super.setup(BiomeGenBase.jungle, BlockX, BlockZ);
            this.generatePyramid();
        }
        else if (super.setup(BiomeGenBase.jungle, BlockX, BlockZ))
        {
            this.generatePyramid();
        }
    }
    ...
    private void generateStairs(int baseheight)
    {
        ...
        {
            this.world.setBlock(putX - 1, putY, putZ, ModBlocks.stairsmossycobblestone, 2, 2);
            this.world.setBlock(putX, putY, putZ, ModBlocks.stairsmossycobblestone, 2, 2);
            this.world.setBlock(putX + 1, putY, putZ, ModBlocks.stairsmossycobblestone, 2, 2);
            this.world.setBlock(putX + 2, putY, putZ, ModBlocks.stairsmossycobblestone, 2, 2);
            ++putZ;
        }
        ...
        for (putY = baseheight; putY < baseheight + this.size / 2; ++putY)
        {
            this.world.setBlock(putX, putY, putZ - 1, ModBlocks.stairsmossycobblestone, 1, 2);
            this.world.setBlock(putX, putY, putZ, ModBlocks.stairsmossycobblestone, 1, 2);
            this.world.setBlock(putX, putY, putZ + 1, ModBlocks.stairsmossycobblestone, 1, 2);
            this.world.setBlock(putX, putY, putZ + 2, ModBlocks.stairsmossycobblestone, 1, 2);
            --putX;
        }
        ...
        for (putY = baseheight; putY < baseheight + this.size / 2; ++putY)
        {
            this.world.setBlock(putX - 1, putY, putZ, ModBlocks.stairsmossycobblestone, 3, 2);
            this.world.setBlock(putX, putY, putZ, ModBlocks.stairsmossycobblestone, 3, 2);
            this.world.setBlock(putX + 1, putY, putZ, ModBlocks.stairsmossycobblestone, 3, 2);
            this.world.setBlock(putX + 2, putY, putZ, ModBlocks.stairsmossycobblestone, 3, 2);
            --putZ;
        }
        ...
        for (putY = baseheight; putY < baseheight + this.size / 2; ++putY)
        {
            this.world.setBlock(putX, putY, putZ - 1, ModBlocks.stairsmossycobblestone, 0, 2);
            this.world.setBlock(putX, putY, putZ, ModBlocks.stairsmossycobblestone, 0, 2);
            this.world.setBlock(putX, putY, putZ + 1, ModBlocks.stairsmossycobblestone, 0, 2);
            this.world.setBlock(putX, putY, putZ + 2, ModBlocks.stairsmossycobblestone, 0, 2);
            ++putX;
        }
        ...
        for (putY = this.maxY - 4; putY < this.maxY; ++putY)
        {
            for (putX = x; putX < x + 8; ++putX)
            {
                ...
                {
                    this.world.setBlock(putX, putY, putZ, ModBlocks.mazestone, this.metadata, 2);
                }
            }
        }
        ...
        {
            this.world.setBlockToAir(x + 3, putY, z);
            this.world.setBlockToAir(x + 4, putY, z);
            this.world.setBlockToAir(x + 7, putY, z + 3);
            this.world.setBlockToAir(x + 7, putY, z + 4);
            this.world.setBlockToAir(x + 3, putY, z + 7);
            this.world.setBlockToAir(x + 4, putY, z + 7);
            this.world.setBlockToAir(x, putY, z + 3);
            this.world.setBlockToAir(x, putY, z + 4);
        }
    }
    ...
    private void generateLadderFromTop()
    {
        ...
        do
        {
            this.world.setBlock(putX, putY--, putZ + 1, Blocks.ladder, 3, 2);
        }
        while (this.world.getBlock(putX, putY, putZ) != Blocks.air);
