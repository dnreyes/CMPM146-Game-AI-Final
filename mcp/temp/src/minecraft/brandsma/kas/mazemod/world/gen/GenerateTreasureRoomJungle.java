...
public class GenerateTreasureRoomJungle extends GenerateTreasureRoom {
   ...
   public GenerateTreasureRoomJungle(World world, Random random, int[] corner1, int mazesize, int cellsize, int foundationheight, int pathwidth, int baseheight) {
      ...
      world.func_147449_b(putX, baseheight + 3, putZ, Blocks.field_150426_aN);
      world.func_147449_b(putX + 3, baseheight + 3, putZ, Blocks.field_150426_aN);
      world.func_147449_b(putX, baseheight + 3, putZ + 3, Blocks.field_150426_aN);
      world.func_147449_b(putX + 3, baseheight + 3, putZ + 3, Blocks.field_150426_aN);
      world.func_147465_d(corner1[0] + Reference.TELEPORTER_LOCATION[this.metadata][0], corner1[1] + Reference.TELEPORTER_LOCATION[this.metadata][1], corner1[2] + Reference.TELEPORTER_LOCATION[this.metadata][2], ModBlocks.teleporter, this.metadata, 2);
   }

   public void generateCorner1(int putX, int putY, int putZ) {
      this.world.func_147465_d(putX, putY, putZ + 2, Blocks.field_150341_Y, 1, 2);
      this.world.func_147465_d(putX + 1, putY, putZ + 1, Blocks.field_150341_Y, 1, 2);
      this.world.func_147465_d(putX + 2, putY, putZ, Blocks.field_150341_Y, 1, 2);
      this.world.func_147449_b(putX, putY + 2, putZ, Blocks.field_150358_i);
   }
