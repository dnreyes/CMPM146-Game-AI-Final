...
import brandsma.kas.mazemod.world.gen.GenerateTreasureRoomDesert;
...
public class GenerateTempleDesert extends GenerateTemple {
   ...
   public void callGeneration(int BlockX, int BlockZ, boolean forceGeneration) {
      if(forceGeneration) {
         super.setup(BiomeGenBase.field_76769_d, BlockX, BlockZ);
         this.generatePyramid();
      } else if(super.setup(BiomeGenBase.field_76769_d, BlockX, BlockZ)) {
         this.generatePyramid();
      }
